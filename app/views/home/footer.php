    ...
    <script src="<?= Domain_Path;  ?>front/js/tether.min.js"></script>
    <script src="<?= Domain_Path;  ?>front/js/bootstrap.min.js"></script>
    <script src="<?= Domain_Path;  ?>front/js/custom.js"></script>
