        ...
        <form role="form" action="/admincategory/postupdate" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="categoryname" value="<?= $data->name; ?>"
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="linkname" value="<?= $data->linkname; ?>"
                           class="form-control" placeholder="Enterlinkname">
                  </div>
                  <div class="form-group">
                    <img src="<?= Domain_Path; ?>images/<?= $data->img; ?>" width="100px" height="100px" alt="" />
                    <br>
